...
//   final _connectToSqlServerDirectlyPlugin = ConnectToSqlServerDirectl();
...
//         try {
//           _connectToSqlServerDirectlyPlugin
//               .getRowsOfQueryResult("select * from dbo.testdb")
//               .then((value) {
...
//                   ? "Insert Into dbo.testdb(Name, Weight) Values('${_nameController.text}', ${double.parse(_weightController.text)})"
//                   : "Insert Into dbo.testdb(Name, Weight) Values('${_nameController.text}', NULL)")
//               .then((value) {
//             if (value.runtimeType == String) {
//               onError(value.toString());
//             } else {
